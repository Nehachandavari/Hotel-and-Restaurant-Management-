...
private:
    ...
    vector<double> prices = {150, 230, 179, 100, 300};
public:
   ...
   Restaurant(const string& restaurantName, int floorNum) {
    ...
    cout << "Total Bill with added GST amount of " << gst << " Rs is " << totalBill << " Rs" << endl;
}
...
public:
    ...
    this->name = guestName;
    this->setAadharNumber(guestAadharNumber);
}
...
public:
    Employee(const string& employeeName, const string& id) {
